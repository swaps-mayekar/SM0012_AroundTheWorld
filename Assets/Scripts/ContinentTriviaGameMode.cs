...
{
    public class ContinentTriviaGameMode : MonoBehaviour
    {
        ...
        private readonly List<TriviaQuestion> _questions = new List<TriviaQuestion>();
        ...
        private void LoadQuestions()
        {
            ...
            {
                Debug.LogError("ContinentTriviaGameMode: Questions JSON is missing.");
                return;
            }

            var data = JsonUtility.FromJson<TriviaQuestionList>(questionsJson.text);
            if (data == null || data.questions == null || data.questions.Length == 0)
            {
                Debug.LogError("ContinentTriviaGameMode: Questions JSON is empty or invalid.");
                return;
            }
            ...
            {
                Debug.LogWarning("ContinentTriviaGameMode: No questions found for continent " + selectedContinent);
            }
        }
        ...
        private void ShowCurrentQuestion()
        {
            ...
            {
                Debug.LogWarning("ContinentTriviaGameMode: Question text is not assigned.");
            }
        ...
        private void PrepareAndShowOptions(TriviaQuestion question)
        {
        ...
        [Serializable]
        private class TriviaQuestionList
        {
