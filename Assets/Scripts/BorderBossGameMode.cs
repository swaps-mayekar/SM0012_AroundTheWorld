...
{
    public class BorderBossGameMode : MonoBehaviour
    {
        ...
        private readonly List<BorderQuestion> _questions = new List<BorderQuestion>();
        ...
        private void LoadQuestions()
        {
            ...
            {
                Debug.LogError("BorderBossGameMode: Questions JSON is missing.");
                return;
            }

            var data = JsonUtility.FromJson<BorderQuestionList>(questionsJson.text);
            if (data == null || data.questions == null || data.questions.Length == 0)
            {
                Debug.LogError("BorderBossGameMode: Questions JSON is empty or invalid.");
                return;
            }
            ...
            {
                Debug.LogWarning("BorderBossGameMode: No questions found for continent " + selectedContinent);
            }
        }
        ...
        private void ShowCurrentQuestion()
        {
            ...
            {
                Debug.LogWarning("BorderBossGameMode: Country name text is not assigned.");
            }
        ...
        private void PrepareAndShowOptions(BorderQuestion question)
        {
        ...
        [Serializable]
        private class BorderQuestionList
        {
            public BorderQuestion[] questions;
        }

        [Serializable]
        private class BorderQuestion
        {
